      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Titre principal avec icônes flottantes */}
            <div className="relative">
              ...
              {/* Icônes flottantes autour du titre */}
              <AnimatedShield className="absolute -top-8 -left-8 w-8 h-8 opacity-60" />
              <AnimatedEye className="absolute -top-4 -right-4 w-6 h-6 opacity-60" />
              <AnimatedLock className="absolute top-8 -left-4 w-6 h-6 opacity-60" />
            </div>
            ...
            {/* Statistiques animées avec icônes */}
            <motion.div 
            ...
            >
              ...
              >
                <div className="relative">
                  <AnimatedShield className="absolute -top-6 -right-2 w-6 h-6 opacity-40" />
              ...
              >
                <div className="relative">
                  <AnimatedLock className="absolute -top-6 -right-2 w-6 h-6 opacity-40" />
                  <div className="text-3xl font-bold text-blue-400">
                    <CountUp 
                      end={800} 
                      duration={2} 
              ...
              >
                <div className="relative">
                  <AnimatedAlert className="absolute -top-6 -right-2 w-6 h-6 opacity-40" />
                  <div className="text-3xl font-bold text-blue-400">
                    <CountUp 
                      end={15} 
                      duration={2} 
            ...
            {/* Liste d'avantages avec icônes animées */}
            <motion.div 
              className="mt-8 flex flex-wrap items-center gap-4 text-sm text-slate-200"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 1 }}
            >
              <span className="flex items-center">
                <AnimatedLock className="w-4 h-4 mr-2" />
                Agents certifiés
              </span>
              <span className="opacity-50">•</span>
              <span className="flex items-center">
                <AnimatedAlert className="w-4 h-4 mr-2" />
               Réponse &lt; 15 minn;
              </span>
              <span className="opacity-50">•</span>
              <span className="flex items-center">
                <AnimatedEye className="w-4 h-4 mr-2" />
                Assurance RC Pro
              </span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            {/* Icônes animées autour de l'image */}
            <AnimatedEye className="absolute -top-8 -left-8 w-10 h-10" />
            <AnimatedLock className="absolute -bottom-4 -right-4 w-8 h-8" />
            <AnimatedShield className="absolute top-1/2 -left-12 w-6 h-6" />
          </motion.div>
        </div>
      </div>
